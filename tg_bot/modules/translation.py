...
__help__ = """
 - /cevir: Bir mesajı yanıtlayın, dilbilgisi düzeltilmiş bir versiyonla size ingilizcesini vereyim. Bu kıyağımı unutmayın
"""

__mod_name__ = "İngilizce çeviri"


TRANSLATE_HANDLER = CommandHandler('cevir', translate)
