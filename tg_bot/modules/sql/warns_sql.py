...
class Warns(BASE):
    ...
    def __repr__(self):
        return "<{}, {} içinde {} için nedenlerden dolayı uyarıyor {}>".format(self.num_warns, self.user_id, self.chat_id, self.reasons)
...
class WarnFilters(BASE):
    ...
    def __repr__(self):
        return "<%s için izinler>" % self.chat_id
...
class WarnSettings(BASE):
    ...
    def __repr__(self):
        return "<{}, {} olası uyarıya sahiptir.>".format(self.chat_id, self.warn_limit)
